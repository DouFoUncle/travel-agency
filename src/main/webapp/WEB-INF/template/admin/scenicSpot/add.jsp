...
<div style="padding: 15px;">
    <form id="myform" action="" method="post" class="layui-form-pane layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="businessStartDate" id="businessStartDate"
            ...
            <div class="layui-input-inline">
                <input type="text" name="businessEndDate" id="businessEndDate"
                       lay-verify="required" placeholder="请选择" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="radio" name="isRed" title="是" value="1"
                       lay-verify="required" autocomplete="off" class="layui-input">
                <input type="radio" name="isRed" title="否" value="0"
            ...
            <div class="layui-input-inline">
                <input type="radio" name="isIndex" title="是" value="1"
                       lay-verify="required" autocomplete="off" class="layui-input">
                <input type="radio" name="isIndex" title="否" value="0"
                       lay-verify="required" autocomplete="off" class="layui-input" checked>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="searchKeyword" lay-verify="required" placeholder="例如：山;五岳(多个用;英文分号隔开)" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label" style="font-size: 14px">购票地址</label>
            <div class="layui-input-block">
                <input type="text" name="skipUrl" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
            ...
            <div class="layui-card-body">
                ...
                <div style="">
                    <div class="layui-upload-list">
                        <img class="layui-upload-img" id="demo1" style="width: 200px; height: 130px">
                        <p id="demoText"></p>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入" autocomplete="off" class="layui-textarea" name="readme" style="height: 80px; resize: none"></textarea>
            </div>
        </div>
        <div>
