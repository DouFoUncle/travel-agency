...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        ...
        <form method="post" class="layui-form" action="adminLogin">
            ...
            <input value="返回首页" style="width:100%;margin-top: 15px" type="button" onclick="window.location.href = getPath() + '/web/system/toWebPage/index/0'">
            <hr class="hr20" >
        </form>
    </div>
</body>
