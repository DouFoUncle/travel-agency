                    ...
                    <form class="layui-form layui-col-space5 layui-form-pane" id="form">
                        ...
                        <div class="layui-inline layui-show-xs-block layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="user.userName" placeholder="请输入">
                            </div>
                        </div>

                        <div class="layui-inline layui-show-xs-block layui-form-item">
                            <label class="layui-form-label">评价攻略</label>
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" name="strategy.title" placeholder="请输入">
                            </div>
                        </div>
...
<script>
    layui.use(['table', 'form', 'laydate'],
        function () {
            ...
            // 初始调用表格加载方法
            loadFunction(getPath() + "/comment/getPageList");
            ...
            $("#searchBtn").click(function () {
                ...
                // 重新调用表格加载方法
                loadFunction(getPath() + "/comment/getPageList?" + sendData)
            })
                    ...
                    , cols:
                        [
                            [ //表头
                                ...
                                , {field: 'name', title: '评价人', width: '18%', templet: '<div>{{d.user.userName}}</div>'}
                                , {field: 'title', title: '评价的攻略', width: '17%', templet: '<div>{{d.strategy.title}}</div>'}
                                , {field: 'content', title: '评价内容', width: '17%'}
                                , {field: 'createDate', title: '评价时间', width: '17%'}
                                , {field: '操作', title: '操作', templet: '#operation', width: '18.8%'}
                            ]
                        ]
            ...
            table.on('tool(listInfo)', function(obj){
                ...
                switch(obj.event){
                    ...
                    case 'del':
                        ...
                        promptRequest(1, "GET", getPath() + "/comment/deleteInfo?ids=" + id, null, null, false);
                        break;
                }
            });
        });
